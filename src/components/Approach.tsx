          ...
          {PRINCIPLES.map((p, i) => (
            <Reveal key={p.title} delay={i * 0.08}>
              <div className="flex h-full flex-col rounded-2xl border border-black/10 bg-white p-8 shadow-[0_14px_40px_rgba(20,10,0,0.06)] dark:border-white/10 dark:bg-coal dark:shadow-none">
                <span className="font-display text-2xl font-bold tracking-tight text-flame">
                  0{i + 1}
                </span>
                <h3 className="mt-5 font-display text-xl font-bold tracking-[-0.01em] text-ink dark:text-white">
                  {p.title}
                </h3>
