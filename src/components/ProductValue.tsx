      ...
      <div className="mx-auto max-w-[1240px] px-6 py-12 sm:px-10 sm:py-14 lg:px-16">
        <Reveal className="relative overflow-hidden rounded-[28px] border border-[#e5d8cb] bg-[#f7f1e9] px-5 py-8 shadow-[0_18px_58px_rgba(70,38,18,0.06)] dark:border-white/[0.085] dark:bg-[#100d0b] dark:shadow-none sm:px-7 sm:py-9 lg:px-9 lg:py-10">
          ...
          <div className="max-w-[560px]">
            ...
            <h2 className="mt-4 max-w-[14ch] font-display text-[clamp(2.2rem,5.2vw,4rem)] font-bold leading-[0.98] tracking-normal text-ink dark:text-white">
              ...
              >
                <div className="relative flex items-start gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <h3 className="mt-3 font-display text-[1.18rem] font-bold leading-tight tracking-normal text-ink dark:text-white sm:text-[1.32rem]">
                      {point.title}
                    </h3>
                    <p className="mt-2 max-w-[46ch] text-sm leading-[1.6] text-ink/60 dark:text-white/60">
                      {point.text}
                    </p>
                    <p className="mt-4 text-[11px] font-semibold uppercase tracking-[0.16em] text-ink/38 transition-colors duration-300 group-hover:text-flame dark:text-white/38 dark:group-hover:text-flame">
                      {point.detail}
                    </p>
                  </div>
                </div>
